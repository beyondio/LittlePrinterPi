...
echo 'SIRIUS_PATH='$SIRIUS_PATH >> /etc/environment #To make sure we keep track where sirius was installed
...
apt-get install $LIST_OF_APPS -y #installing all the prerequisite
...
chmod 755 /usr/local/bin/phantomjs #make it executable
